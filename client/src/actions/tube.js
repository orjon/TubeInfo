...
export const getStations = (calledFrom) => async dispatch => {
  ...
  try {
    ...
    console.log(moment(response.data.statusesTimeStamp).format('HH:mm:ss'),'GOT stations')
...
// --------------------------------------------------------------
export const getStationArrivals= ({calledFrom, stationId}) => async dispatch => {
  ...
  try {
    ...
    console.log(moment(response.data.arrivalsTimeStamp).format('HH:mm:ss'),'GOT stationArrivals')
...
export const getStatuses = (calledFrom) => async dispatch => {
  ...
  try {
    ...
    console.log(moment(response.data.statusesTimeStamp).format('HH:mm:ss'),'GOT statuses')
