...
export function findStationFromId(stationToFind){
  return state.tube.stations.find(function(station){
    return station.id === stationToFind;
  })
}

export function findStationIndexFromId(stationId){
  return state.tube.stations.findIndex(station => station.id === stationId)
}
